...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    lateinit var verticeText: TextView
    lateinit var verticeValue:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        verticeText = findViewById(R.id.area_text)
        verticeValue = findViewById(R.id.area_value)
...
//                    }
        ...
        fab_area.setOnClickListener {
            try {
                ...
                AlertDialog.Builder(this).setTitle("Warning").setIcon(R.drawable.caution)
                    ...
                    .setNeutralButton("delete all", DialogInterface.OnClickListener { _, _ ->
                        VerticesLongLat.clear()
                        verticeValue.text = VerticesLongLat.size.toString()
                    }).show()
        ...
        areaToggle.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                ...
                verticeValue.isVisible = false
                verticeText.isVisible = false
            } else {
                areaMode = true
                verticeValue.isVisible = true
                verticeText.isVisible = true
